...
Веб-сервис для проекта Pascalixs. Отвечает за отображение интерфейса пользователя, перенаправление запросов авторизации в identity-service и обработку событий от других микросервисов через Kafka.
...
KAFKA_CLIENT_ID=web-portal
KAFKA_GROUP_ID=web-portal_development
...
```bash
sudo chown -R $USER:$USER /home/goldie/Documents/Ruby\ Projects/My_learn_projects_2025/microservices/web-portal
```
...
## Взаимодействие с identity-service

Web Portal взаимодействует с identity-service через:
